...
export const DICTS: Record<Lang, Dict> = {
  es: {
    labels: {
      ...
      lastName: "Apellidos",
      email: "Email",
      diallingCode: "Prefijo telefónico de país",
      phone: "Número de teléfono",
      country: "País de residencia",
      tradingExperience: "¿Cuál es tu Experiencia en Trading?",
    },
    acceptance:
    ...
    validation: {
      ...
      diallingCode: "Selecciona el prefijo telefónico",
      phone: "Número de teléfono no válido",
      country: "Selecciona tu país de residencia",
      tradingExperience: "Selecciona tu experiencia en trading",
  ...
  en: {
    labels: {
      ...
      lastName: "Last name",
      email: "Email",
      diallingCode: "Country dialing code",
      phone: "Phone number",
      country: "Country of residence",
      tradingExperience: "What's your trading experience?",
    },
    acceptance:
    ...
    validation: {
      ...
      diallingCode: "Select the dialing code",
      phone: "Invalid phone number",
      country: "Select your country of residence",
      tradingExperience: "Select your trading experience",
  ...
  pt: {
    labels: {
      ...
      lastName: "Sobrenome",
      email: "E-mail",
      diallingCode: "Código de discagem do país",
      phone: "Número de telefone",
      country: "País de residência",
      tradingExperience: "Qual é a sua experiência em trading?",
    },
    acceptance:
    ...
    validation: {
      ...
      diallingCode: "Selecione o código de discagem",
      phone: "Número de telefone inválido",
      country: "Selecione seu país de residência",
      tradingExperience: "Selecione sua experiência em trading",
